            ...
            $userown_id='';
                ...
                if(isset($_GET['u_id'])){
                    ...
                    echo"
                        <div class='row'>
                            ...
                            <ul class='list-group'>
                                ...
                                <li class='list-group-item' title='User Status'><strong style='color:grey;'>$describe_user</strong>
                                </li>
                                ...
                                <li class='list-group-item' title='User Registration Date'><strong>$register_date</strong>
                                </li>
                            </ul>
                    ...
                    if($user_id == $userown_id){
                        echo"<a herf='edit_profile.php?u_id=$userown_id' class='btn btn-success'/>Edit Profile</a><br><br><br>";
                    }

...
<div class="row">
    <div class="col-sm-12">
        <div class="well">
            <center><h1 style="color: white;"><strong>Chatbook</strong></h1></center>
        </div>
    </div>
</div>
<div clss="row">
        ...
        <div class="main-content">
            ...
            <div class="l_pass">
                <form action="" method="post">
                    ...
                    <input id="msg" type="text" class="form-control" name="recovery_account" placeholder="Someone"
                        required>
                    </div><br>
                    <a style="texy-decoration: none;float: right;color: #187FAB;" data-toggle="tooltip"
                    title="Signin" href="signin.php">Back to Signin?</a><br><br>

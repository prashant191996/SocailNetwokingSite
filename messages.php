...
<?php
  ...
  //  } 
?>
    <div class="col-sm-3" id="selcet_user">
        <?php
        ...
        // $user_from_msg='';
                ...
                while($row_msg = mysqli_fetch_array($run_msg)){
                    ...
                    <div id="loaded_msg">
                        ...
                        $user_from_msg){echo"<div class= 'message' id = 'green' data-toggle
                            ='tooltip' title = '$msg_date'>$msg_body</div><br><br><br>";}?></p>
                    </div>
            ...
            if(isset($_GET['u_id'])){
                ...
                if($u_id == "new"){
                    echo'
                        ...
                        <form>
                            ...
                            <textarea disabled class="from-control" placeholder="Enter your Message" cols="70" rows="4"></textarea>
                ...
                echo'    
                    <form action="" method ="POST">
                            <textarea class="from-control" placeholder="Enter your Message" name="msg_box" id="message_textarea" cols="70" rows="4"></textarea>
                    ...
                    <div class='row'>
                        ...
                        <div style='background-color: #e6e6e6;' class='col-sm-9'>
                            ...
                            <ul class='list-group'>
                                ...
                                <li class='list-group-item' title='User Status'><strong class='color: grey;'>
